...
<ol>
<li><strong>-s DIR, --source DIR</strong> (The path or paths of the source folder(s) where all RB files are found e.g., files ending in *.js.rb.)</li>
<li><strong>-o DIR, --output DIR</strong> (The path or paths of the output folder(s) where all Ruby code will be translated into JavaScript with the prepared file type.)</li>
...
<p>This dumped content is stored in the 'src/json/users.json' file. Therefore it is necessary to create the necessary folder or file.</p>
<pre class="hljs"><code><div>{
